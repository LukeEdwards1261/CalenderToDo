fetch('http://localhost:8999/task/readAll')
  ...
  function createTableBody(table,taskData) {
      ...
      let row = table.insertRow();
        ...
        myViewButton.href= 'OctRecord.html?id='+taskRecord.id
  ...
  document.getElementById("createOctTable").addEventListener('click',function(stop){
    stop.preventDefault();
    ...
    createOctTable(title, task, type);
  ...
  function createOctTable(title,task,type){
...
function deleteAllOctoberEvent(id) {
  let taskId = parseInt(id);
