fetch('http://localhost:8999/task/readAll')
  ...
  function createTableBody(table,taskData) {
      ...
      let row = table.insertRow();
        ...
        myViewButton.href= 'DecRecord.html?id='+taskRecord.id //this line 
  ...
  document.getElementById("createDecTable").addEventListener('click',function(stop){ //this line
    stop.preventDefault();
    ...
    createDecTable(title, task, type); //this line
  ...
  function createDecTable(title,task,type){ //this line
...
function deleteDecRecord(id){ // this line
  ...
  document.getElementById("DeleteAllDecemberEvent").addEventListener('click',function(stop){   // this line
    stop.preventDefault();
    deleteAllDec(); // this line
    console.log("Testing")
      }
    )


function deleteAllDec(){ // this line
     for (let Id = 1; Id < 50; Id++) {
       if(document.getElementById("deletetask"+Id)){
        deleteAllDecemberEvent(Id); // this line
        console.log("the Id of this record is: "+Id);
       }
       }  
    window.location.reload(); 
...
function deleteAllDecemberEvent(id) { //this line
  let taskId = parseInt(id);
